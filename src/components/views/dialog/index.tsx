...
import { BREAKPOINTS } from 'app-components/commons/constants'
import Icon from 'app-components/elements/icon'
import IconButton from 'app-components/inputs/icon-button'
import { useMediaQuery } from 'app-libs/client/utils'
...
const Dialog: React.FunctionComponent<DialogProps> = ({
  ...
  const sm = useMediaQuery(`(min-width: ${BREAKPOINTS.small}px)`)
